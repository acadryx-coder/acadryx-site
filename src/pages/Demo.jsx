  ...
  return (
    <>
      ...
      <section className="section">
        <div className="wrap">
          <div style={{ background: "var(--ink)", borderRadius: "var(--r-xl)", padding: "40px 10px", display: "flex", justifyContent: "center" }}>
            <iframe src="https://acadryx-demo.vercel.app" style={{ width: "100vw", height: 700, border: "none", borderRadius: 16 }} title="Acadryx Demo" />
          </div>
