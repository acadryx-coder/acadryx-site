...
const FAQ = [
  ...
  { q: "How does pricing work for different school sizes?", a: "It scales naturally—a small school with 100 students pays ₦100,000 per term. A large school with 2,000 students pays ₦2,000,000. Schools typically add ₦1000 to student fees per term, and parents see exactly what they're paying for: a platform their child uses daily, with permanent records, parent access, and alumni connection that lasts forever. No hidden costs. Just transparent, fair pricing." },
          ...
          <div className="pricing-wrap" style={{ maxWidth: 860, margin: "0 auto" }}>
            <div className="price-grid">
                ...
                <ul className="price-list">
                  {["Your school's own branded web app — fully customizable",
                    "One-click school-wide digital result generation and publication",
                  	...
                  	"Permanent, verifiable credentials. Lifetime storage & access enabled"].map((x,i)=><li key={i}>{x}</li>)}
                </ul>
              ...
              <div className="price-col light">
                <div style={{ fontSize: ".68rem", fontWeight: 700, letterSpacing: ".1em", textTransform: "uppercase", color: "var(--text-3)", marginBottom: 16 }}>Add-On Feature Marketplace</div>
        ...
        <div className="wrap">
          <div style={{ maxWidth: 760, margin: "0 auto", background: "var(--teal-soft)", borderRadius: "var(--r-xl)", padding: "40px 44px", border: "1px solid rgba(13,124,150,.15)", textAlign: "center" }}>
            ...
            <p style={{ color: "var(--text-2)", lineHeight: 1.8, maxWidth: 580, margin: "0 auto" }}>
              Acadryx charges ₦1000 per active student account. Disable accounts for school-fee defaulters, without deleting.
              A 500-student Nigerian school pays ₦500,000 per term — no upfront, no annual contract, pay as you go.
            </p>
          </div>
        </div>
      </section>
